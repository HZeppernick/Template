        ...
        <footer className="footer">
            <Container>
                <Row className="align-items-center">
                    ...
                    <br /><br />
                        Impressum: <br /> <br />
                        Akademisch-Musikalische Verbindung Nordmark zu Hamburg <br />
                        Ohlsdorfer Straße 39a <br />
                        22299 Hamburg <br />
                        Tel.: 040/79307096 <br /><br />
                        E-Mail: webmaster@amv-nordmark.de <br /><br />
                    ...
                    <Col sm={6} className="text-center text-sm-end">
                        ...
                        <button onClick={() => setButtonPopup(true)}>Datenschutz</button>
...
<br />
<br />
AMV Nordmark zu Hamburg
<br />
Ohlsdorfer Straße 39a
<br />
22299 Hamburg
<br />
Telefon: +49 040/79307096
<br />
E-Mail: praeside@amv-nordmark.de
<br />
<br />
...
<h2>4. Datenerfassung auf dieser Website Kontaktformular</h2>
